      ...
      <div className="home-content-wrapper">
        <div className="categories-wrapper-new">
          <div className="categories-container-inner">
            <div
              className={`cat-item-new ${
                selectedCategory === "All" ? "cat-active" : ""
              }`}
              onClick={() => setSelectedCategory("All")}
            >
              <img
                src="https://imgs.search.brave.com/vWK1-2VeKFxI0x8e31g3HKSV3FvzRHuC-TMv8WE5QAg/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9jZG4t/aWNvbnMtcG5nLmZy/ZWVwaWsuY29tLzI1/Ni81MTEwLzUxMTA3/ODUucG5nP3NlbXQ9/YWlzX3doaXRlX2xh/YmVs"
                alt="all"
              />
            ...
            <div className="banner-glass-slider">
              ...
              <div className="offer-badge-timer">
                ...
                <span className="timer-txt">
                  SALE ENDS IN: <b>{formatTime(timeLeft)}</b>
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="modern-filter-bar">
          <div className="filter-left">
            ...
            <div className="filter-chips">
              <button
                className={sortType === "default" ? "chip-active" : ""}
              ...
              <button
                className={sortType === "lowToHigh" ? "chip-active" : ""}
              ...
              <button
                className={sortType === "highToLow" ? "chip-active" : ""}
        ...
        {selectedProduct && (
          ...
          >
            <div
              className="modal-content premium-layout"
              ...
              <div className="modal-main-grid">
                <div className="modal-gallery-side">
                  <div className="main-display-box">
                    <img
                      src={previewImg || selectedProduct.img}
                      alt="Product"
                  ...
                  <div className="thumbnail-track">
                    <img
                      ...
                      className={
                        previewImg === selectedProduct.img
                          ? "thumb-active"
                          : "thumb-normal"
                      }
                    ...
                    {selectedProduct.subImages &&
                      selectedProduct.subImages.map((s, idx) => (
                        <img
                          key={idx}
                          src={s}
                          className={
                            previewImg === s ? "thumb-active" : "thumb-normal"
                          }
    ...
    <div className="app-container">
      <header className="navbar-fixed">
        <div className="nav-container">
          ...
          {isHomePage && (
            <div
              className="search-section desktop-search"
            ...
            {user ? (
              <div className="user-nav-dropdown">
                ...
                <div className="dropdown-links">
                  ...
                  {isAdmin && (
                    <Link to="/seller" style={{ color: "red" }}>
                      Admin Panel
                    </Link>
                  )}
              ...
              <Link to="/login" className="login-link-new">
                Login
              </Link>
            )}

            <Link to="/cart" className="cart-link-nav hide-mobile">
              🛒 Cart ({cart.length})
            </Link>
          </div>
        </div>
